...
from MultiNano.model.modelOneGASF import ReadLevelModel
from MultiNano.utils.MyDataSet_txt import MyDataSetTxt_read_level, clear_linecache
...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        if curr_val_min_loss < val_results_epoch['acc']:
            curr_val_min_loss = val_results_epoch['acc']
...
def argparser():
    ...
    parser.add_argument("--train_file",
                        default=r"/root/autodl-tmp/syn/train/syn_rep1_sl.11mer_65_features.train_0.8_0k_rl.txt",
                        required=False)
    parser.add_argument("--valid_file",
                        default=r"/root/autodl-tmp/syn/train/syn_rep1_sl.11mer_65_features.valid_0.2_0k_rl.txt",
                        required=False)
    ...
    parser.add_argument("--save_dir", default="/root/autodl-tmp/1111New/syn/syn_ni_all", required=False, help='modelTrans.pt save dir')
